...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { correction_hbm_dout { I 64 vector } correction_hbm_num_data_valid { I 4 vector } correction_hbm_fifo_cap { I 4 vector } correction_hbm_empty_n { I 1 bit } correction_hbm_read { O 1 bit } } \
} "
}
