...
module predecoder_kernel_Block_entry1_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [6:0] m_axi_gmem0_RFIFONUM;
...
reg    ap_block_state1;
wire  signed [63:0] sext_ln238_fu_66_p1;
wire   [57:0] trunc_ln_fu_56_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state72) & (m_axi_gmem0_RVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state72) & (m_axi_gmem0_RVALID == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_block_state1) | (m_axi_gmem0_ARREADY == 1'b0))) begin
...
always @ (*) begin
    if ((~((1'b1 == ap_block_state1) | (m_axi_gmem0_ARREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign m_axi_gmem0_ARADDR = sext_ln238_fu_66_p1;
...
assign sext_ln238_fu_66_p1 = $signed(trunc_ln_fu_56_p4);

assign trunc_ln_fu_56_p4 = {{syndrome_hbm[63:6]}};

endmodule //predecoder_kernel_Block_entry1_proc
