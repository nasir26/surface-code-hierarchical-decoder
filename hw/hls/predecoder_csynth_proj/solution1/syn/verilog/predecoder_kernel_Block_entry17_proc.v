...
module predecoder_kernel_Block_entry17_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        p_read,
        correction_hbm_dout,
        correction_hbm_num_data_valid,
        correction_hbm_fifo_cap,
        correction_hbm_empty_n,
        correction_hbm_read,
        m_axi_gmem1_AWVALID,
        m_axi_gmem1_AWREADY,
        m_axi_gmem1_AWADDR,
...
output   ap_ready;
input  [511:0] p_read;
input  [63:0] correction_hbm_dout;
input  [3:0] correction_hbm_num_data_valid;
input  [3:0] correction_hbm_fifo_cap;
input   correction_hbm_empty_n;
output   correction_hbm_read;
...
reg   [57:0] trunc_ln_reg_102;
reg    ap_block_state1;
wire  signed [63:0] sext_ln255_fu_92_p1;
reg   [70:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem1_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        trunc_ln_reg_102 <= {{correction_hbm_dout[63:6]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem1_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        correction_hbm_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (1'b0 == ap_block_state1))) begin
        correction_hbm_read = 1'b1;
    end else begin
        correction_hbm_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (m_axi_gmem1_AWREADY == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (m_axi_gmem1_WREADY == 1'b1))) begin
...
always @ (*) begin
    ap_block_state1 = ((correction_hbm_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
assign m_axi_gmem1_AWADDR = sext_ln255_fu_92_p1;
...
assign m_axi_gmem1_WDATA = p_read;
...
assign sext_ln255_fu_92_p1 = $signed(trunc_ln_reg_102);

endmodule //predecoder_kernel_Block_entry17_proc
